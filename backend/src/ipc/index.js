...
const registerExpenseVouchers = require('./expenseVouchers.ipc');
...
const registerReceiptVouchers = require('./receiptVouchers.ipc');
...
const registerStockVouchers = require('./stockVouchers.ipc');
