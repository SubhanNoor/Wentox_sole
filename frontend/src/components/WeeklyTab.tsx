...
import { Calendar, Search, ArrowLeft, FileText, Edit2, Printer, MapPin } from 'lucide-react';
            ...
            {customerCardsData.length === 0 ? (
              <tr>
                <td colSpan={6} className="text-center p-12 text-slate-400">
                  ...
                  <p className="font-lora text-base font-semibold text-slate-500 mb-1">No Weekly Records Found</p>
                  <p className="text-xs max-w-sm mx-auto">No sales were recorded for this week matching your filters.</p>
                </td>
              </tr>
            ) : (
