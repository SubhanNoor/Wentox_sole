...
interface OverallExpensesTabProps {
...
export default function OverallExpensesTab({ onVoucherUnposted }: OverallExpensesTabProps) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-lora font-bold text-lg text-slate-800">
                Voucher #{activeVoucherHeader?.voucher_no ?? selectedVoucherId} — Expenses Ledger
              </h3>
            ...
            {voucherCardsData.length === 0 ? (
              <tr>
                <td colSpan={5} className="text-center p-12 text-slate-400">
                  ...
                  <p className="font-lora text-base font-semibold text-slate-500 mb-1">No Expenses Found</p>
                  <p className="text-xs max-w-sm mx-auto">No expenses were logged matching your search filters.</p>
                </td>
              </tr>
            ) : (
