...
export default function SearchModal({
  isOpen, title, options, value, onSelect, onClose, searchPlaceholder = 'Search...', onHighlightChange
}: SearchModalProps) {
  ...
  // type to search" has to work the same way on the second open as the first.
  useEffect(() => {
    if (!isOpen) return;
    setSearch('');
  ...
  // SearchableSelect's own convention.
  useEffect(() => {
    if (!isOpen) return;
